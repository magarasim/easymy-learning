...
import { Github, Linkedin, Twitter, MessageSquare, Filter, Search } from "lucide-react";
...
const InternshipProgram = () => {
  ...
  const roles = Array.from(new Set(interns.map(intern => intern.role)));
          ...
          <div className="flex flex-col md:flex-row gap-4 max-w-2xl mx-auto mb-8">
            <div className="relative flex-1">
              ...
              <Input
                ...
                className="pl-10 w-full bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm"
              />
            </div>
            <select
              value={selectedRole || ''}
              onChange={(e) => setSelectedRole(e.target.value || null)}
              className="px-4 py-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm"
            >
              ...
              >
                <Sheet>
                  <SheetTrigger asChild>
                    <Card className="relative overflow-hidden cursor-pointer transform transition-all duration-300 hover:shadow-2xl dark:bg-gray-800/90 backdrop-blur-sm border-2 hover:border-blue-500 group">
                      <div className="aspect-square relative">
                        ...
                        <div className="absolute bottom-4 left-4 right-4 text-white transform transition-transform duration-300">
                          <h3 className="text-xl font-semibold mb-1 truncate group-hover:scale-105">{intern.name}</h3>
